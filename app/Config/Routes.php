...
$routes->group('superadmin', ['filter' => 'superauth'], function($routes) {
    ...
    $routes->get('view_organization/(:num)', 'SuperAdmin::view_organization/$1');
    $routes->get('edit_organization/(:num)', 'SuperAdmin::edit_org_view/$1');
    ...
    $routes->post('creators/delete/(:num)', 'SuperAdminCreators::delete/$1');
...
$routes->group('org', ['filter' => 'orgauth'], function($routes) {
    ...
    $routes->get('systems/access-groups/edit/(:num)', 'OrgSystems::editGroup/$1', ['filter' => 'orgauth:cms.systems.access_groups.edit']);
    ...
    $routes->get('academics/departments/delete/(:num)', 'OrgAcademics::delete_department/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/programs/delete/(:num)', 'OrgAcademics::delete_program/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/academic_years/delete/(:num)', 'OrgAcademics::delete_academic_year/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/semesters/delete/(:num)', 'OrgAcademics::delete_semester/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/cohorts/delete/(:num)', 'OrgAcademics::delete_cohort/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/subjects/delete/(:num)', 'OrgAcademics::delete_subject/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/regulations/delete/(:num)', 'OrgAcademics::delete_regulation/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('academics/sections/delete/(:num)', 'OrgAcademics::delete_section/$1', ['filter' => 'orgauth:cms.academics.academic_structure.delete']);
    ...
    $routes->get('timetable/periods/(:num)', 'OrgTimetable::periods/$1');
    $routes->post('timetable/periods/auto-generate/(:num)', 'OrgTimetable::autoGeneratePeriods/$1');
    $routes->post('timetable/periods/save', 'OrgTimetable::savePeriod');
    $routes->post('timetable/periods/delete/(:num)', 'OrgTimetable::deletePeriod/$1');
    ...
    $routes->get('staff/generate_pdf/(:num)', 'OrgStaff::generate_pdf/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('attendance/take/(:num)', 'OrgAttendance::take/$1');
    ...
    $routes->post('obe/po/delete/(:num)', 'OrgObe::deletePo/$1', ['filter' => 'orgauth']);
    $routes->get('obe/co-setup', 'OrgObe::coSetup', ['filter' => 'orgauth']);
    $routes->post('obe/co/save', 'OrgObe::saveCo', ['filter' => 'orgauth']);
    $routes->post('obe/co/delete/(:num)', 'OrgObe::deleteCo/$1', ['filter' => 'orgauth']);
    ...
    $routes->post('marks/components/delete/(:num)', 'OrgMarks::deleteComponent/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('assessments/edit/(:num)', 'OrgAssessments::edit/$1', ['filter' => 'orgauth']);
    $routes->post('assessments/save', 'OrgAssessments::save', ['filter' => 'orgauth']);
    $routes->get('assessments/delete/(:num)', 'OrgAssessments::delete/$1', ['filter' => 'orgauth']);
    $routes->get('assessments/submissions/(:num)', 'OrgAssessments::submissions/$1', ['filter' => 'orgauth']);
    $routes->get('assessments/grade/(:num)', 'OrgAssessments::grade/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('internships/editPosting/(:num)', 'OrgInternships::editPosting/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('internships/applications/(:num)', 'OrgInternships::applications/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('internships/reviewStudent/(:num)', 'OrgInternships::reviewStudent/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('assignments/edit/(:num)', 'OrgAssignments::edit/$1', ['filter' => 'orgauth']);
    $routes->post('assignments/save', 'OrgAssignments::save', ['filter' => 'orgauth']);
    $routes->post('assignments/delete/(:num)', 'OrgAssignments::delete/$1', ['filter' => 'orgauth']);
    $routes->get('assignments/submissions/(:num)', 'OrgAssignments::submissions/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('quizzes/edit/(:num)', 'OrgQuizzes::edit/$1');
    $routes->post('quizzes/save', 'OrgQuizzes::save');
    $routes->post('quizzes/delete/(:num)', 'OrgQuizzes::delete/$1');
    $routes->get('quizzes/questions/(:num)', 'OrgQuizzes::questions/$1');
    $routes->post('quizzes/save_question', 'OrgQuizzes::saveQuestion');
    $routes->post('quizzes/delete_question/(:num)', 'OrgQuizzes::deleteQuestion/$1');
    $routes->get('quizzes/results/(:num)', 'OrgQuizzes::results/$1');

    // Materials Module
    $routes->get('materials', 'OrgMaterials::index', ['filter' => 'orgauth']);
    $routes->get('materials/create', 'OrgMaterials::create', ['filter' => 'orgauth']);
    $routes->get('materials/edit/(:num)', 'OrgMaterials::edit/', ['filter' => 'orgauth']);
    $routes->post('materials/save', 'OrgMaterials::save', ['filter' => 'orgauth']);
    $routes->post('materials/delete/(:num)', 'OrgMaterials::delete/', ['filter' => 'orgauth']);

    // HR & Payroll Module
    $routes->get('hr/settings', 'OrgHrSettings::index');
    $routes->post('hr/settings/save_department', 'OrgHrSettings::saveDepartment');
    $routes->post('hr/settings/delete_department/(:num)', 'OrgHrSettings::deleteDepartment/$1');
    $routes->post('hr/settings/save_designation', 'OrgHrSettings::saveDesignation');
    $routes->post('hr/settings/delete_designation/(:num)', 'OrgHrSettings::deleteDesignation/$1');
    $routes->post('hr/settings/save_employment_type', 'OrgHrSettings::saveEmploymentType');
    $routes->post('hr/settings/delete_employment_type/(:num)', 'OrgHrSettings::deleteEmploymentType/$1');
    $routes->post('hr/settings/save_leave_policy', 'OrgHrSettings::saveLeavePolicy');
    $routes->post('hr/settings/delete_leave_policy/(:num)', 'OrgHrSettings::deleteLeavePolicy/$1');
    $routes->get('hr/employees', 'OrgEmployees::index');
    $routes->post('hr/employees/save', 'OrgEmployees::save');
    $routes->post('hr/employees/delete/(:num)', 'OrgEmployees::delete/$1');
    $routes->get('hr/leaves', 'OrgLeaves::index');
    $routes->post('hr/leaves/apply', 'OrgLeaves::apply');
    $routes->post('hr/leaves/update_status/(:num)', 'OrgLeaves::updateStatus/$1');

    // HR Appraisals
    $routes->get('hr/appraisals', 'OrgHrAppraisals::index');
    $routes->post('hr/appraisals/save', 'OrgHrAppraisals::save');
    $routes->get('hr/appraisals/delete/(:num)', 'OrgHrAppraisals::delete/$1');
    ...
    $routes->get('payroll/components/delete/(:num)', 'OrgPayroll::delete_component/$1');
    $routes->get('payroll/structures', 'OrgPayroll::structures');
    $routes->post('payroll/structures/save', 'OrgPayroll::save_structure');
    $routes->get('payroll/structures/delete/(:num)', 'OrgPayroll::delete_structure/$1');
    ...
    $routes->get('admissions/leads/delete/(:num)', 'OrgAdmissions::delete_lead/$1', ['filter' => 'orgauth:cms.admissions.leads.delete']);
    $routes->get('admissions/leads/convert/(:num)', 'OrgAdmissions::convert_lead/$1', ['filter' => 'orgauth:cms.admissions.applications.convert']);
    ...
    $routes->get('admissions/enrollment/process/(:num)', 'OrgAdmissions::enroll_student/$1', ['filter' => 'orgauth:cms.admissions.enrollment.create']);
    ...
    $routes->get('fee-config/program/(:num)', 'OrgFeeConfig::programBatches/$1', ['filter' => 'orgauth']);
    $routes->get('fee-config/semester-plan/(:num)/(:num)/(:num)', 'OrgFeeConfig::semesterPlan/$1/$2/$3', ['filter' => 'orgauth']);
    ...
    $routes->get('fee-payments/receipt/(:num)', 'OrgFeePayments::receipt/$1', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/update_application_status/(:num)', 'OrgExaminations::update_application_status/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('examinations/print-hall-ticket/(:num)', 'OrgExaminations::print_hall_ticket/$1', ['filter' => 'orgauth']);
    $routes->get('examinations/marks', 'OrgExaminations::marks', ['filter' => 'orgauth']);
    $routes->get('examinations/enter-marks/(:num)', 'OrgExaminations::enter_marks/$1', ['filter' => 'orgauth']);
    ...
    $routes->post('administration/delete-lecture-hall/(:num)', 'OrgAdministration::delete_lecture_hall/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('transport/delete_vehicle/(:num)', 'OrgTransport::delete_vehicle/$1', ['filter' => 'orgauth']);
    $routes->match(['get', 'post'], 'transport/routes', 'OrgTransport::routes', ['filter' => 'orgauth']);
    $routes->get('transport/delete_route/(:num)', 'OrgTransport::delete_route/$1', ['filter' => 'orgauth']);
    $routes->match(['get', 'post'], 'transport/halts', 'OrgTransport::halts', ['filter' => 'orgauth']);
    $routes->get('transport/delete_halt/(:num)', 'OrgTransport::delete_halt/$1', ['filter' => 'orgauth']);
    $routes->match(['get', 'post'], 'transport/subscriptions', 'OrgTransport::subscriptions', ['filter' => 'orgauth']);
    $routes->get('transport/delete_subscription/(:num)', 'OrgTransport::delete_subscription/$1', ['filter' => 'orgauth']);
    $routes->match(['get', 'post'], 'transport/logbook', 'OrgTransport::logbook', ['filter' => 'orgauth']);
    $routes->get('transport/delete_logbook/(:num)', 'OrgTransport::delete_logbook/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('placements/drives/(:num)/applications', 'OrgPlacements::drive_applications/$1');
    $routes->post('placements/applications/update', 'OrgPlacements::update_application');
    $routes->get('placements/applications/issue-offer/(:num)', 'OrgPlacements::issue_offer_from_applicant/$1');
    ...
    $routes->get('correspondence/delete_template/(:num)', 'OrgCorrespondence::delete_template/$1');
    ...
    $routes->get('students/profile/(:num)', 'OrgStudents::profile/$1', ['filter' => 'orgauth']);
    $routes->get('students/create', 'OrgStudents::create', ['filter' => 'orgauth']);
    $routes->get('students/edit/(:num)', 'OrgStudents::edit/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('students/unlink-parent/(:num)', 'OrgStudents::unlinkParent/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('front-office/visitors/checkout/(:num)', 'OrgFrontOffice::checkoutVisitor/$1', ['filter' => 'orgauth']);
    $routes->get('front-office/visitors/print-pass/(:num)', 'OrgFrontOffice::printPass/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('front-office/calls/delete/(:num)', 'OrgFrontOffice::deleteCall/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('front-office/postal/delete/(:num)', 'OrgFrontOffice::deletePostal/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('front-office/enquiries/convert/(:num)', 'OrgFrontOffice::convertToAdmission/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('certificates/delete/(:num)', 'OrgCertificates::delete_template/$1', ['filter' => 'orgauth']);
    $routes->get('certificates/generate', 'OrgCertificates::generate', ['filter' => 'orgauth']);
    $routes->get('certificates/print/(:num)/(:num)', 'OrgCertificates::print_certificate/$1/$2', ['filter' => 'orgauth']);
...
$routes->group('lms', ['filter' => 'lmsauth'], function($routes) {
    ...
    $routes->get('assessments/view/(:num)', 'LmsAssessments::view/$1');
    $routes->post('assessments/submit/(:num)', 'LmsAssessments::submit/$1');

    // Enterprise Internships (Module 2)
    $routes->get('internships', 'LmsInternships::index');
    $routes->get('internships/apply/(:num)', 'LmsInternships::apply/$1');
    ...
    $routes->get('internships/workspace/(:num)', 'LmsInternships::workspace/$1');
    ...
    $routes->get('materials/watch/(:num)', 'LmsMaterials::watchCourse/$1');
    
    // Assignments
    $routes->get('assignments', 'LmsAssignments::index');
    $routes->get('assignments/view/(:num)', 'LmsAssignments::view/$1');
    $routes->post('assignments/submit', 'LmsAssignments::submit');
    
    // Quizzes (LMS)
    $routes->get('quizzes', 'LmsQuizzes::index');
    $routes->get('quizzes/start/(:num)', 'LmsQuizzes::start/$1');
    $routes->get('quizzes/exam/(:num)', 'LmsQuizzes::exam/$1');
...
$routes->group('parent', ['filter' => 'parentauth'], function($routes) {
    ...
    $routes->get('dashboard/select_student/(:num)', 'ParentDashboard::select_student/$1');
...
$routes->group('creator', ['filter' => 'creatorauth'], function($routes) {
    ...
    $routes->get('courses/edit/(:num)', 'CreatorStudio::edit/$1');
    $routes->post('courses/saveCourse', 'CreatorStudio::saveCourse');
    $routes->get('courses/builder/(:num)', 'CreatorStudio::builder/$1');
    $routes->get('courses/preview/(:num)', 'CreatorStudio::preview/$1');
    $routes->post('courses/saveChapter', 'CreatorStudio::saveChapter');
    $routes->post('courses/deleteChapter/(:num)', 'CreatorStudio::deleteChapter/$1');
    $routes->post('courses/saveLesson', 'CreatorStudio::saveLesson');
    $routes->post('courses/deleteLesson/(:num)', 'CreatorStudio::deleteLesson/$1');
    $routes->get('courses/togglePublish/(:num)', 'CreatorStudio::togglePublish/$1');
    $routes->get('courses/delete/(:num)', 'CreatorStudio::deleteCourse/$1');
});
...
$routes->group('api', function($routes) {
    ...
    $routes->group('parent', ['filter' => 'apiauth:parent'], function($routes) {
        ...
        $routes->get('ward/(:num)/attendance', 'Api\ParentApiController::ward_attendance/$1');
        $routes->get('ward/(:num)/timetable', 'Api\ParentApiController::ward_timetable/$1');
        $routes->get('ward/(:num)/marks', 'Api\ParentApiController::ward_marks/$1');
        $routes->get('ward/(:num)/fees', 'Api\ParentApiController::ward_fees/$1');
    });
});
