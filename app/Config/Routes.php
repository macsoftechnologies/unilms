...
$routes->group('org', ['filter' => 'orgauth'], function($routes) {
    ...
    $routes->get('admissions/documents/verify/(:segment)', 'OrgAdmissions::verify_documents/$1', ['filter' => 'orgauth']);
    ...
    $routes->get('admissions/offers/accept/(:segment)', 'OrgAdmissions::accept_offer/$1', ['filter' => 'orgauth']);
    $routes->get('admissions/offers/pdf/(:segment)', 'OrgAdmissions::offer_pdf/$1', ['filter' => 'orgauth']);
    $routes->get('admissions/payments', 'OrgAdmissions::payments', ['filter' => 'orgauth:cms.admissions.payments.view']);
    $routes->post('admissions/payments/save', 'OrgAdmissions::save_payment', ['filter' => 'orgauth']);
    $routes->get('admissions/enrollment', 'OrgAdmissions::enrollment', ['filter' => 'orgauth']); 
    $routes->match(['get', 'post'], 'admissions/enrollment/process/(:segment)', 'OrgAdmissions::enroll_student/$1', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/save-exam', 'OrgExaminations::save_exam', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/save-schedule', 'OrgExaminations::save_schedule', ['filter' => 'orgauth']);
    $routes->get('examinations/applications', 'OrgExaminations::applications', ['filter' => 'orgauth']);
    $routes->post('examinations/save_application', 'OrgExaminations::save_application', ['filter' => 'orgauth']);
    $routes->post('examinations/save-application', 'OrgExaminations::save_application', ['filter' => 'orgauth']);
    $routes->post('examinations/update_application_status/(:segment)', 'OrgExaminations::update_application_status/$1', ['filter' => 'orgauth']);
    $routes->post('examinations/update-application-status/(:segment)', 'OrgExaminations::update_application_status/$1', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/save-marks', 'OrgExaminations::save_marks', ['filter' => 'orgauth']);
    ...
    $routes->get('examinations/set-papers', 'OrgExaminations::set_papers', ['filter' => 'orgauth']);
    $routes->post('examinations/save_paper', 'OrgExaminations::save_paper', ['filter' => 'orgauth']);
    $routes->post('examinations/save-paper', 'OrgExaminations::save_paper', ['filter' => 'orgauth']);
    $routes->get('examinations/external_registrations', 'OrgExaminations::external_registrations', ['filter' => 'orgauth']);
    $routes->get('examinations/external-registrations', 'OrgExaminations::external_registrations', ['filter' => 'orgauth']);
    $routes->post('examinations/save_external_registration', 'OrgExaminations::save_external_registration', ['filter' => 'orgauth']);
    $routes->post('examinations/save-external-registration', 'OrgExaminations::save_external_registration', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/save-invigilation', 'OrgExaminations::save_invigilation', ['filter' => 'orgauth']);
    ...
    $routes->post('examinations/save-grant', 'OrgExaminations::save_grant', ['filter' => 'orgauth']);
    $routes->post('examinations/save_expenditure', 'OrgExaminations::save_expenditure', ['filter' => 'orgauth']);
    $routes->post('examinations/save-expenditure', 'OrgExaminations::save_expenditure', ['filter' => 'orgauth']);
    ...
    $routes->post('administration/save-location', 'OrgAdministration::save_location', ['filter' => 'orgauth']);
    ...
    $routes->post('administration/save-agent', 'OrgAdministration::save_agent', ['filter' => 'orgauth']);
    ...
    $routes->post('administration/save-holiday', 'OrgAdministration::save_holiday', ['filter' => 'orgauth']);
